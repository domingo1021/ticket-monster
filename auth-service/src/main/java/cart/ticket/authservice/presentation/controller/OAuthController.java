...
public class OAuthController {
  ...
  public OAuthController(RestTemplateBuilder restTemplateBuilder, JwtProvider jwtProvider, UserService userService) {
  ...
  public ResponseEntity<?> handleGoogleCallback(
    ...
    if (responseEntity.getStatusCode().is2xxSuccessful()) {
      ...
      if (tokenResponse != null) {
        ...
        ResponseEntity<Map<String, Object>> userInfoResponse = restTemplate.exchange(
                GOOGLE_USERINFO_ENDPOINT, HttpMethod.GET, userDetailRequest, new ParameterizedTypeReference<>() {});
    ...
    return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Failed to exchange authorization code or fetch user info");
  }
}

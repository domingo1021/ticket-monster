...
public class WebSocketHandler extends TextWebSocketHandler {
  ...
  private final List<String> subscriptionWhitelist = List.of(WebSocketConstants.TICKET_STATUS);
   ...
   *
   * @param payload the message payload, example: {"action": "subscription", "data": { "type": "ticket-status" }}
